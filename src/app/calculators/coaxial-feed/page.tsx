import { CoaxialFeedCalculator } from '@/components/calculators/coaxial-feed/CoaxialFeedCalculator';
import { AntennaIcon } from '@/components/ui/Icons';

export default function CoaxialFeedPage() {
  return (
