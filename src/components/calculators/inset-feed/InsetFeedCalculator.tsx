...
import { CalculatorInputs, CalculationResults } from '@/lib/calculators/inset/types';
import { performCalculation } from '@/lib/calculators/inset/calculations';
...
export const InsetFeedCalculator: React.FC = () => {
