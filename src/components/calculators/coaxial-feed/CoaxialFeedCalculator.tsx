...
import { CalculatorInputs, CalculationResults } from '@/lib/calculators/coaxial/types';
import { performCalculation } from '@/lib/calculators/coaxial/calculations';
...
export const CoaxialFeedCalculator: React.FC = () => {
